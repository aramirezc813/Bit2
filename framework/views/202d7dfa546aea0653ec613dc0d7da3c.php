...
<?php $__env->startSection('title','Ip'); ?>
                ...
                <table id="datatablesSimple" class="table table-striped">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $ip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ips): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="<?php echo e($ips->asignado == 3 ? 'tablaneutro' : 'tablaazul'); ?>">
                                <td>10.40.130.<?php echo e($ips->descripcion); ?></td>
                                <td>
                                    <?php if($ips->asignado == 3): ?>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('ip.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Bit2\resources\views/ip/index.blade.php ENDPATH**/ ?>