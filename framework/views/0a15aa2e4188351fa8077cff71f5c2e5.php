...
<head>
    ...
    <link href="<?php echo e(asset('css/template.css'  , true   )); ?>" rel="stylesheet" />
    ...
    <style type="text/css">
        body {
            background-image: url(<?php echo e(url('assets/img/loginimg4.jpg' )); ?>);/* ,[],true */
...
<?php /**PATH C:\xampp\htdocs\Bit2\resources\views/auth/login.blade.php ENDPATH**/ ?>