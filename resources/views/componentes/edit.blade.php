...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Editar Componente</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item "><a href="{{route('panel.index')}}">Inicio</a></li>
            <li class="breadcrumb-item active"><a href="{{route('componentes.index')}}">Tipos de Componente</a></li>
...
<div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
       <form action="{{route('componentes.update',['componente'=> $componentes->id,$componentes->descripcion ])}}" method="post">   
         @method('PATCH') 
        @csrf   
        <div class="row g-3">
            ...
            <div class="col-md-12">
                ...
                <textarea name="descripcion" id="descripcion" rows="3" class="form-control">{{old('descripcion',$componentes->descripcion )}}</textarea>
                @error('descripcion')
